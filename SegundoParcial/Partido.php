...
class Partido{
 ...
 public function setObjEquipo2($objEquipo2){
    ...
    public function darEquipoGanador(){
        ...
        }else if($cantGolesE1 < $cantGolesE2){
            $ganador[] = $objEquipo2;
        }else{
            $ganador[]= $objEquipo1;
            array_push($ganador, $objEquipo2);
        }

        return $this->devolverArreglos($ganador);
    }
    ...
    public function coeficientePartido(){
        ...
        // $objEquipo2 = $this->getObjEquipo2()->getCantJugadores();
        $coefResultado = null;

        $coefResultado =  $cantGoles * $cantJugadores;
